insert into user (email, first_name, last_name, password) values( 'admin@ya.ru','Бока','Легендарный','$2a$12$BhV16O/lWayy8kW2nnNrCOpDzmBUJmUC1l0aL6T5YRj4MZw7lk.QK');
insert into user (email, first_name, last_name, password) values( 'user@mail.ru','Жока','Популярный','$2a$12$A7ya4uExmEKCNqv9ljc4O.hCbTBspywfNF5xL2JFhl9IQq2qJAsZK');
